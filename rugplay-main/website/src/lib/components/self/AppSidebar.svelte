<script lang="ts">
	...
	import RobuxPaymentModal from './RobuxPaymentModal.svelte';
	...
	const data = {
		navMain: [
			...
			{ title: 'Create Item', url: '/coin/create', icon: Coins },
	...
	let showRobuxPayment = $state(false);
...
<RobuxPaymentModal bind:open={showRobuxPayment} />
	...
	<Sidebar.Header>
		<div class="flex items-center gap-2 px-2 py-2">
			...
			<div class="flex items-center gap-2">
				<span class="text-base font-semibold">RobuxMarket</span>
					...
					<div class="space-y-2 px-2 py-1">
						...
						{:else}
							<div class="flex items-center justify-between">
								...
								<Badge variant="secondary" class="font-mono bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
									{formatCurrency($PORTFOLIO_SUMMARY.totalValue)} R$
								</Badge>
							</div>
							<Button 
								size="sm" 
								class="w-full mt-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700"
								onclick={() => showRobuxPayment = true}
							>
							...
							<div class="text-muted-foreground space-y-1 text-xs">
								<div class="flex justify-between">
									...
									<span class="font-mono text-blue-600 dark:text-blue-400"
										>{formatCurrency($PORTFOLIO_SUMMARY.baseCurrencyBalance)} R$</span
									>
								</div>
								<div class="flex justify-between">
									<span>Items:</span>
									<span class="font-mono">{formatCurrency($PORTFOLIO_SUMMARY.totalCoinValue)} R$</span
									>
								</div>
							</div>
						{/if}
